	...
	\footnotesize{
		\begin{forest} decision tree,for tree={s sep=25pt}
				[Chamberlain, plain content
						[Hitler;\text{Concesión},plain content,elo={yshift=4pt}
								[{1,$x$};\text{Guerra}]
								[{3,$x$};\text{NG}]
						]
						[Hitler;\text{NC},plain content,elo={yshift=4pt}
								[{2,$x$};\text{Guerra}]
								[{4,$x$};\text{NG}]
						]
				]
...
\begin{figure}[H]
	...
	\footnotesize{
		\begin{forest} decision tree,for tree={s sep=25pt}
			[Naturaleza, plain content
			[Chamberlain;\text{Amigable, $p=0.6$},plain content,elo={yshift=10pt},alias=izq
			[Hitler;\text{Concesión},plain content,elo={yshift=4pt}
				[{1,3};\text{Guerra}]
				[{3,4};\text{NG}]
			]
			...
			[Chamberlain;\text{Beligerante, $p=0.4$}, plain content,elo={yshift=10pt},alias=der
			[Hitler;\text{Concesión},plain content,elo={yshift=4pt}
				[{1,4};\text{Guerra}]
				[{3,2};\text{NG}]
			]
